...
// TODO re-check if we need AB homing bump
...
// @section lcd
  ...
  // TODO change AB manual movement speed
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 1*60, 1*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
